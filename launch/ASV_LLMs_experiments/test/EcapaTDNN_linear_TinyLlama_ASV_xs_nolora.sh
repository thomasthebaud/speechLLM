...
#SBATCH --error=logs/ASV_LLM/test/EcapaTDNN_linear_TinyLlama_ASV_xs_nolora_%j.log
#SBATCH --output=logs/ASV_LLM/test/EcapaTDNN_linear_TinyLlama_ASV_xs_nolora_%j.log
