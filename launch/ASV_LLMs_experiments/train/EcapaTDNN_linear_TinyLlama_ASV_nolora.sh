...
#SBATCH --error=logs/ASV_LLM/train/EcapaTDNN_linear_TinyLlama_ASV_nolora_%j.log
#SBATCH --output=logs/ASV_LLM/train/EcapaTDNN_linear_TinyLlama_ASV_nolora_%j.log
