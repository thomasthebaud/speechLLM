...
#SBATCH --error=logs/test/wavlm-base-plus_linear_TinyLlama_lr1e-3_gender_%j.log
#SBATCH --output=logs/test/wavlm-base-plus_linear_TinyLlama_lr1e-3_gender_%j.log
#SBATCH --exclude=e05
