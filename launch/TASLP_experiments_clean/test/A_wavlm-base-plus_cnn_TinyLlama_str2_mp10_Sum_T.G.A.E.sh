...
#SBATCH --error=logs/TASLP_clean/test/A_wavlm-base-plus_cnn_TinyLlama_str2_mp10_Sum_T.G.A.E_%j.log
#SBATCH --output=logs/TASLP_clean/test/A_wavlm-base-plus_cnn_TinyLlama_str2_mp10_Sum_T.G.A.E_%j.log
