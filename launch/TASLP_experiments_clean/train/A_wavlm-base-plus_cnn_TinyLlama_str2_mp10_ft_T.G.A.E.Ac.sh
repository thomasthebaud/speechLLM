...
#SBATCH --error=logs/TASLP_clean/train/A_wavlm-base-plus_cnn_TinyLlama_str2_mp10_ft_T.G.A.E.Ac_%j.log
#SBATCH --output=logs/TASLP_clean/train/A_wavlm-base-plus_cnn_TinyLlama_str2_mp10_ft_T.G.A.E.Ac_%j.log
