...
#SBATCH --error=logs/TASLP_clean/train/A_wavlm-base-plus_ft_cnn_TinyLlama_str2_mpIN4.2x5_Sum3_T.G.A_1hmax_%j.log
#SBATCH --output=logs/TASLP_clean/train/A_wavlm-base-plus_ft_cnn_TinyLlama_str2_mpIN4.2x5_Sum3_T.G.A_1hmax_%j.log
