...
#SBATCH --error=logs/TASLP_clean/train/A_wavlm-base-plus_cnn_TinyLlama_str2_mp800_Sum_%j.log
#SBATCH --output=logs/TASLP_clean/train/A_wavlm-base-plus_cnn_TinyLlama_str2_mp800_Sum_%j.log
