...
#SBATCH --error=logs/TASLP/train/A_wavlm-base-plus_cnn_TinyLlama_str2_mpIN2.2.2.2_ft_Sum_T.G.A.E.Ac_%j.log
#SBATCH --output=logs/TASLP/train/A_wavlm-base-plus_cnn_TinyLlama_str2_mpIN2.2.2.2_ft_Sum_T.G.A.E.Ac_%j.log
