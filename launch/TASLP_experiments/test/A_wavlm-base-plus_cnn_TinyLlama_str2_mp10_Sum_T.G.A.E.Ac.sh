...
#SBATCH --error=logs/TASLP/test/A_wavlm-base-plus_cnn_TinyLlama_str2_mp10_Sum_T.G.A.E.Ac_%j.log
#SBATCH --output=logs/TASLP/test/A_wavlm-base-plus_cnn_TinyLlama_str2_mp10_Sum_T.G.A.E.Ac_%j.log
