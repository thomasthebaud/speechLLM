...
#SBATCH --error=logs/train/A_wavlm-base-plus_cnn_TinyLlama_str2_mp10_Sum_%j.log
#SBATCH --output=logs/train/A_wavlm-base-plus_cnn_TinyLlama_str2_mp10_Sum_%j.log
